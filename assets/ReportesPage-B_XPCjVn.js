import{c as Me,r as w,h as $,f as p,j as e,F as ie,x as we,w as qe,y as Ve,R as Ye,d as Ue,s as E,A as Ke}from"./index-BVev1oWj.js";import{L as $e}from"./loader-circle-CX2qxuz4.js";import{D as Je}from"./download-BkjiSSAq.js";import{F as He}from"./file-text-u4s3cO7J.js";import{R as ne,T as de,B as Ee,C as Xe}from"./generateCategoricalChart-CNajrB9f.js";import{A as Qe,a as Ze}from"./AreaChart-ChN8q_yR.js";import{C as le,X as ce,Y as pe,B as Fe}from"./BarChart-Chpq9GVT.js";import{C as et}from"./calendar-Cm4GnkvI.js";/**
 ...
 */const at=Me("Minus",[["path",{d:"M5 12h14",key:"1ays0h"}]]),st=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"];function ot(f,k){const s=k.granularidad,h=new Map,S=d=>{const m=String(d||"").slice(0,10);return m?s==="mes"?m.slice(0,7):m:null},D=d=>{var F;if(s==="mes"){const[,X]=d.split("-");return((F=st[parseInt(X,10)-1])==null?void 0:F.slice(0,3))||d}const[,m,j]=d.split("-");return`${j}/${m}`};for(const d of f||[]){const m=S(d.fecha);if(!m)continue;h.has(m)||h.set(m,{clave:m,label:D(m),pedidos:0,entregados:0,devueltos:0,ventasBrutas:0,ingresoEntregado:0});const j=h.get(m);j.pedidos++,j.ventasBrutas+=d.total||0,d.estado==="entregado"&&(j.entregados++,j.ingresoEntregado+=d.total||0),d.estado==="devuelto"&&j.devueltos++}return[...h.values()].sort((d,m)=>d.clave.localeCompare(m.clave))}function rt({actual:f,anterior:k,invertido:s=!1}){if(k==null||k===0)return e.jsx("span",{style:{color:"var(--text-muted)",fontSize:10},children:"nuevo"});const h=(f-k)/k*100,S=s?h<0:h>0,D=Math.abs(h)<.5?"var(--text-muted)":S?"var(--green)":"var(--red)",d=h>.5?Ke:h<-.5?tt:at;return e.jsxs("span",{style:{color:D,fontSize:10,fontWeight:700,display:"inline-flex",alignItems:"center",gap:1},children:[e.jsx(d,{size:10}),Math.abs(h).toFixed(0),"%"]})}function gt(){var ge,ve,he,xe;const[f,k]=w.useState(new Date().toISOString().substring(0,7)),[s,h]=w.useState(null),[S,D]=w.useState(!1),[d,m]=w.useState(!1),j=w.useRef(),F=w.useCallback(async()=>{D(!0);const[a,i]=f.split("-").map(Number),l=`${f}-01`,n=new Date(a,i,0).toISOString().slice(0,10),u=new Date(a,i-2,1),b=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}-01`,M=new Date(u.getFullYear(),u.getMonth()+1,0).toISOString().slice(0,10),T={tipo:"mensual",granularidad:"dia",inicio:l,fin:n,inicioPrev:b,finPrev:M,etiqueta:new Date(a,i-1,1).toLocaleDateString("es-PY",{month:"long",year:"numeric"})},[v,c,y,_,Q,W]=await Promise.all([$(()=>E.from("ventas").select("n_referencia, fecha, total, estado, ganancia_neta, costo_prod, costo_envio, producto_nombre, ciudad, cliente_telefono").gte("fecha",l).lte("fecha",n).order("fecha")),$(()=>E.from("ventas").select("fecha, total, estado, ganancia_neta").gte("fecha",b).lte("fecha",M)),$(()=>E.from("gastos").select("fecha, monto").gte("fecha",l).lte("fecha",n)),$(()=>E.from("campanas_ads").select("*").gte("mes",l.slice(0,7)).lte("mes",n.slice(0,7))),$(()=>E.from("productos").select("id, nombre, costo_unit, activo").eq("activo",!0)),$(()=>E.from("entregas").select("n_referencia, categoria, estado_pap, motivo, importe, rendido, dias_rendicion, fecha_entrega").gte("fecha_entrega",l).lte("fecha_entrega",n),{columnaOrden:"nro_guia_pap"})]),P=(v||[]).filter(t=>t.estado==="entregado"),R=(v||[]).filter(t=>t.estado==="pendiente"),L=(v||[]).filter(t=>t.estado==="devuelto"),x={};(v||[]).forEach(t=>{x[t.producto_nombre]||(x[t.producto_nombre]={nombre:t.producto_nombre,ventas:0,entregados:0,devueltos:0,ingresos:0}),x[t.producto_nombre].ventas++,t.estado==="entregado"&&(x[t.producto_nombre].entregados++,x[t.producto_nombre].ingresos+=t.ganancia_neta||0),t.estado==="devuelto"&&x[t.producto_nombre].devueltos++});const A=Object.values(x).map(t=>{const o=t.entregados+t.devueltos;return{...t,tasaDevolucion:o?Math.round(t.devueltos/o*100):0}}).sort((t,o)=>o.ingresos-t.ingresos),O=new Date(a,i,0).getDate(),q=new Date().toISOString().slice(0,10),B=[];for(let t=1;t<=O;t++){const o=`${f}-${String(t).padStart(2,"0")}`,g=P.filter(I=>I.fecha===o);(g.length>0||o<=q)&&B.push({dia:t,ventas:g.reduce((I,re)=>I+re.total,0),neto:g.reduce((I,re)=>I+(re.ganancia_neta||0),0),cantidad:g.length})}const r=(y||[]).reduce((t,o)=>t+o.monto,0),z=(_||[]).reduce((t,o)=>t+o.gasto,0),N=(c||[]).filter(t=>t.estado==="entregado"),Z={ventasBrutas:N.reduce((t,o)=>t+o.total,0),ingresosNetos:N.reduce((t,o)=>t+(o.ganancia_neta||0),0),paquetes:(c||[]).length,entregados:N.length,devueltos:(c||[]).filter(t=>t.estado==="devuelto").length,tasaEntrega:(c||[]).length?N.length/(c||[]).length*100:0},ee=W||[],fe=ee.filter(t=>t.categoria==="entregado"||(t.estado_pap||"").toLowerCase().includes("entregado")),te=fe.filter(t=>t.rendido),be=fe.filter(t=>!t.rendido),ae=te.map(t=>t.dias_rendicion).filter(t=>t!=null&&t>=0),V={cobrado:te.reduce((t,o)=>t+(o.importe||0),0),porCobrar:be.reduce((t,o)=>t+(o.importe||0),0),nRendidas:te.length,nSinRendir:be.length,tiempoCobro:ae.length?ae.reduce((t,o)=>t+o,0)/ae.length:null,hayCobranza:ee.some(t=>t.rendido||t.fecha_rendido)},C={};(v||[]).forEach(t=>{const o=(t.ciudad||"Sin ciudad").trim();C[o]||(C[o]={ciudad:o,pedidos:0,entregados:0,devueltos:0}),C[o].pedidos++,t.estado==="entregado"&&C[o].entregados++,t.estado==="devuelto"&&C[o].devueltos++});const je=Object.values(C).map(t=>{const o=t.entregados+t.devueltos;return{...t,tasaEntrega:o?Math.round(t.entregados/o*100):0,tasaDevolucion:o?Math.round(t.devueltos/o*100):0}}).filter(t=>t.pedidos>=2).sort((t,o)=>o.pedidos-t.pedidos),_e=["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"],Y={};for(let t=0;t<7;t++)Y[t]={entregados:0,devueltos:0};(v||[]).forEach(t=>{if(!t.fecha)return;const o=String(t.fecha).slice(0,10).split("-").map(Number);if(o.length!==3)return;const g=new Date(o[0],o[1]-1,o[2]).getDay();t.estado==="entregado"?Y[g].entregados++:t.estado==="devuelto"&&Y[g].devueltos++});const ye=[1,2,3,4,5,6,0].map(t=>{const o=Y[t],g=o.entregados+o.devueltos;return{dia:_e[t].slice(0,3),devolucion:g?Math.round(o.devueltos/g*100):0,total:g}}),se={};ee.filter(t=>t.categoria==="devuelto"||(t.estado_pap||"").toLowerCase().includes("devuelto")).forEach(t=>{const o=(t.motivo||"Sin motivo").trim();se[o]=(se[o]||0)+1});const Re=Object.entries(se).map(([t,o])=>({motivo:t,count:o})).sort((t,o)=>o.count-t.count),U={};(v||[]).forEach(t=>{const o=String(t.cliente_telefono||"").replace(/\D/g,"");o.length>=6&&(U[o]=(U[o]||0)+1)});const Le=Object.keys(U).length,Ae=Object.values(U).filter(t=>t>1).length,G=[];A.filter(t=>t.entregados+t.devueltos>=3&&t.tasaDevolucion>=35).forEach(t=>G.push({tipo:"producto",texto:`"${t.nombre}" tiene ${t.tasaDevolucion}% de devolución. Revisá la confirmación antes de despachar o filtrá ciudades.`})),je.filter(t=>t.pedidos>=3&&t.tasaDevolucion>=50).slice(0,4).forEach(t=>G.push({tipo:"ciudad",texto:`${t.ciudad}: ${t.tasaDevolucion}% de devolución (${t.pedidos} pedidos). Considerá confirmar por WhatsApp o pausar esa zona.`})),V.porCobrar>0&&G.push({tipo:"cobranza",texto:`PaP te debe ${p(V.porCobrar)} de ${V.nSinRendir} entregas. Reclamá las más viejas en Rendición.`});const K=[...ye].filter(t=>t.total>=3).sort((t,o)=>o.devolucion-t.devolucion)[0];K&&K.devolucion>=45&&G.push({tipo:"patron",texto:`Los pedidos del ${K.dia} se devuelven ${K.devolucion}%. Evaluá no despachar ese día o reforzar la confirmación.`});const J=t=>P.reduce((o,g)=>o+(t(g)||0),0),ke=t=>R.reduce((o,g)=>o+(t(g)||0),0),Be=t=>L.reduce((o,g)=>o+(t(g)||0),0),H=J(t=>t.total),Se=J(t=>t.costo_prod),Ge=ke(t=>t.costo_prod),Ne=J(t=>t.costo_envio),Pe=ke(t=>t.costo_envio),ze=Be(t=>t.costo_envio),oe=Ne+ze,Ie=oe+Pe,De=J(t=>t.ganancia_neta),We=H,Ce=Se,Oe=We-oe-r-Ce;h({mes:f,periodo:T,serie:ot(v||[],T),ventasBrutas:H,ingresosNetos:De,totalGastos:r,totalGastoAds:z,cogsEntregadas:Se,cogsPendientes:Ge,costoMercaderiaVendida:Ce,fleteEntregadas:Ne,fletePendientes:Pe,fleteDevoluciones:ze,fleteFirme:oe,fleteTotal:Ie,margenPct:H?De/H*100:0,paquetesEnviados:(v||[]).length,entregados:P.length,devueltos:L.length,pendientesCount:R.length,tasaEntrega:(v||[]).length?P.length/(v||[]).length*100:0,utilidadNeta:Oe,porProducto:A,porDia:B,campanas:_||[],ventas:v||[],comparativa:Z,cobranza:V,ciudades:je,porDiaSemana:ye,motivos:Re,clientesUnicos:Le,recompradores:Ae,alertas:G}),D(!1)},[f]),X=()=>{if(!s)return;m(!0);const a="fw-print-styles";let i=document.getElementById(a);i||(i=document.createElement("style"),i.id=a,document.head.appendChild(i)),i.textContent=`
    ...
    `;const l=document.title;document.title=`facial-wellness-reporte-${s.mes}`;const n=()=>{document.title=l,m(!1),window.removeEventListener("afterprint",n)};window.addEventListener("afterprint",n),setTimeout(()=>{window.print(),setTimeout(n,1e3)},150)},Te=()=>{var A,O,q,B;if(!s)return;const a=s,i=r=>"Gs. "+Number(r||0).toLocaleString("es-PY"),l=r=>r==null?"—":Number(r).toFixed(1)+"%",n=r=>String(r??"").replace(/[<>&]/g,z=>({"<":"&lt;",">":"&gt;","&":"&amp;"})[z]),u=a.paquetesEnviados||0,b=a.entregados||0,M=a.devueltos||0,T=a.pendientesCount||0,v=b,c=r=>"<tr>"+r.map((z,N)=>`<td${N>0?' class="num"':""}>${z}</td>`).join("")+"</tr>",y=(r,z)=>`<table><thead><tr>${r.map((N,Z)=>`<th${Z>0?' class="num"':""}>${n(N)}</th>`).join("")}</tr></thead><tbody>${z.join("")}</tbody></table>`,_=(a.serie||[]).map(r=>c([n(r.label),r.pedidos,r.entregados,r.devueltos,i(r.ventasBrutas),i(r.ingresoEntregado)])),Q=(a.porProducto||[]).map(r=>c([n(r.nombre),r.ventas,r.entregados,r.devueltos,l(r.tasaDevolucion),i(r.ingresos)])),W=(a.ciudades||[]).slice(0,30).map(r=>c([n(r.ciudad||r.nombre),r.total??r.pedidos,r.entregados??"—",r.devueltos??"—",r.tasaEntrega!=null?l(r.tasaEntrega):"—"])),P=(a.motivos||[]).map(r=>c([n(r.motivo||r.nombre),r.cantidad??r.count])),R={nasal:"Tiras Nasales",parche:"Parches Bucales",gudair:"Pack Gudair",lengua:"Raspador de Lengua",jaw:"JawFlex Pro",botella:"Botella Flexible",bebird:"Bebird Pro",total:"Total del mes"},L=(a.campanas||[]).map(r=>c([n(R[r.nombre]||R[r.familia]||r.nombre||"—"),i(r.gasto||r.inversion||0)])),x=window.open("","_blank");if(!x){toast("Permití las ventanas emergentes para descargar el PDF","error");return}x.document.write(`<!DOCTYPE html><html lang="es"><head><meta charset="utf-8">
<title>Reporte completo — ${n(((A=a.periodo)==null?void 0:A.etiqueta)||a.mes)}</title>
<style>
...
${y(["Etapa","Cantidad","% del total"],[c(["Pedidos enviados",u,"100%"]),c(["Entregados",b,u?l(b/u*100):"—"]),c(["Devueltos",M,u?l(M/u*100):"—"]),c(["En proceso / pendientes",T,u?l(T/u*100):"—"]),c(["Cobrados (entregados)",v,u?l(v/u*100):"—"])])}
...
${L.length?y(["Producto / campaña","Gasto"],L):"<p>Sin campañas cargadas en el período.</p>"}
